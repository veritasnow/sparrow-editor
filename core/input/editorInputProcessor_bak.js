...
export function createEditorInputProcessor(state, ui, domSelection) {
    ...
    function processInput() {
        ...
        const currentState = state.getState().present.editorState;
    ...
    function saveFinalState(lineIndex, updatedLine, restoreData) {
        const nextState = [...state.getState().present.editorState];
        nextState[lineIndex] = updatedLine;
        state.saveEditorState(nextState);
